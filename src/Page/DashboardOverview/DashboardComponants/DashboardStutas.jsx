...
const DashboardStutas = () => {
    const stats = [
        ...
        },
        {
            ...
            value: '98',
            growth: '+77%',
            icon: <img src="/public/Image/Icon (3).png" alt="" />,
        ...
        },
        {
            ...
            value: '23',
            growth: '+18%',
            icon: <img src="/public/Image/Icon (4).png" alt="" />,
            color: 'bg-orange-500',
        },
        {
            ...
            value: '34',
            growth: '+8%',
            icon: <img src="/public/Image/Icon.png" alt="" />,
        ...
        },
        {
            ...
            value: '6',
            growth: '-3%',
            icon: <img src="/public/Image/Icon (2).png" alt="" />,
            color: 'bg-red-500',
        },
        {
            ...
            value: '3:42',
            growth: '+15%',
            icon: <img src="/public/Image/Icon (5).png" alt="" />,
            color: 'bg-indigo-500',
        },
    ];
