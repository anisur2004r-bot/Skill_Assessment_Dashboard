...
const ActivityRequest = () => {
  ...
  const activity = [
    { text: "AI booked appointment for iPhone 13 screen repair", time: "2 min ago", dot: "bg-green-500" },
    { text: "Warm transfer to technician - Software issue", time: "5 min ago", dot: "bg-orange-500" },
    { text: "Quote provided for iPad battery replacement", time: "8 min ago", dot: "bg-green-500" },
    { text: "Call dropped after 12 seconds", time: "15 min ago", dot: "bg-red-500" },
  ];
  const requests = [
    { name: "Screen Repair", count: 156, percent: "85%" },
    { name: "Battery Replacement", count: 89, percent: "55%" },
    { name: "Back Glass Repair", count: 67, percent: "40%" },
    { name: "Software Issues", count: 45, percent: "25%" },
  ];
