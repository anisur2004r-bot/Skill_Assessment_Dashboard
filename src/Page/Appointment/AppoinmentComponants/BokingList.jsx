...
const BokingList = ({ clientDetails }) => {
    return (
        <div>
            <div className='bg-[#111B3B] rounded-2xl overflow-x-auto'>
            ...
            <div className='flex flex-wrap items-center justify-center mt-10 gap-6 text-xl text-[#1146B1]'>
                ...
                <p>3</p>
                <p className='hidden sm:block'>4</p>
                <p className='hidden sm:block'>5</p>
                <p className='hidden sm:block'>....</p>
                <p className='hidden sm:block'>11</p>
